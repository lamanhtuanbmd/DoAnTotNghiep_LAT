...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.GetViewGioHang> {
    ...
    public void onBindViewHolder(@NonNull GetViewGioHang holder, int position) {
        ...
        holder.xoa_giohang.setContentDescription(String.valueOf(position));
        holder.card_GioHang.setContentDescription(String.valueOf(position));
        holder.cong_giohang.setContentDescription(String.valueOf(position));
        holder.tru_giohang.setContentDescription(String.valueOf(position));
    ...
    public class GetViewGioHang extends  RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public GetViewGioHang(@NonNull View itemView) {
            ...
            card_GioHang = itemView.findViewById(R.id.card_GioHang);
